...
Baralho Baralho::criaBaralhoSerrado()
{
    ...
    for (int i = 0; i < 8; ++i)
    {
        ...
        baralho._cartas.push_back(new CartaMonstro("Charía", 5, 3, 4, 3,
